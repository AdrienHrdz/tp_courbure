...
public:
    ...
    vec3 const& vertex(int ku,int kv) const;
    vec3& vertex(int ku,int kv);
    vec3 const& normal(int ku,int kv) const;
    vec3& normal(int ku,int kv);
    vec3 const& color(int ku,int kv) const;
    vec3& color(int ku,int kv);
    vec2 const& texture_coord(int ku,int kv) const;
